...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.dat_Claims_p', 'U') IS NOT NULL AND OBJECT_ID('mi_ATM881_ACOI.dbo.dat_Claims', 'U') IS NOT NULL
...
FROM
	...
	left join mi_ATM881_ACOI.dbo.tmpref_hospice_clm_type_claim_id as c
