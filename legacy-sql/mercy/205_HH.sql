...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_tmp_HH1', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_tmp_HH1;
...
FROM
	...
	left join mi_ATM881_ACOI.dbo.tmpref_ccn_flag as c
...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_tmp_HH2', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_tmp_HH2;
...
SELECT
	...
	, max(e.er) as er
INTO
	mi_ATM881_ACOI.dbo.A_tmp_HH2
FROM
	mi_ATM881_ACOI.dbo.A_tmp_HH1 as a
	left join
		(
		SELECT
			FROM_DATE
...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_HH', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_HH;
...
INTO
	mi_ATM881_ACOI.dbo.A_HH
FROM
	mi_ATM881_ACOI.dbo.A_tmp_HH2 as a
...
(459931 row(s) affected)
Warning: Null value is eliminated by an aggregate or other SET operation.

(459931 row(s) affected)
Warning: Null value is eliminated by an aggregate or other SET operation.

(52799 row(s) affected)
