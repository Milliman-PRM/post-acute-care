...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_tmp_ACSA1', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_tmp_ACSA1;
...
INTO
	mi_ATM881_ACOI.dbo.A_tmp_ACSA1
FROM
...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_tmp_ACSA2', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_tmp_ACSA2;
...
SELECT
	...
	,a.amt_paid
into
	mi_ATM881_ACOI.dbo.A_tmp_ACSA2
from
	mi_ATM881_ACOI.dbo.dat_Claims as a
	left join mi_ATM881_ACOI.dbo.A_tmp_ACSA1 as b
...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_ACSA', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_ACSA;
...
INTO
	mi_ATM881_ACOI.dbo.A_ACSA
FROM
	mi_ATM881_ACOI.dbo.A_tmp_ACSA2 as a
...
(122450 row(s) affected)

(43756 row(s) affected)
