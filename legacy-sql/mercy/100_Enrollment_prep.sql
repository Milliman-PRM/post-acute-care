...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_Enrollment_Key', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_Enrollment_Key;
...
FROM
	...
	FROM
		...
		left join mi_ATM881_ACOI.dbo.dat_membermonth_udd as x
...
/*
	...
	WHERE
		x.curr_assgn = 1 
		and year([MEMBER_MONTH_START_DATE]) = (select max(year([MEMBER_MONTH_START_DATE])) from mi_ATM881_ACOI.dbo.dat_MEMBMTHS)*/
	) as a
GO



IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_Enrollment_Summary1', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_Enrollment_Summary1;
...
SELECT
	...
	,sum([AGE]) as [AGE]
INTO
	mi_ATM881_ACOI.dbo.A_Enrollment_Summary1
FROM
	mi_ATM881_ACOI.dbo.A_Enrollment_Key
GROUP BY
	[INCURRED_YEAR_AND_MONTH]
...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_Enrollment_Summary2', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_Enrollment_Summary2;
...
SELECT
	...
	,sum([AGE]) as [AGE]
INTO
	mi_ATM881_ACOI.dbo.A_Enrollment_Summary2
FROM
	mi_ATM881_ACOI.dbo.A_Enrollment_Summary1
GROUP BY
	[INCURRED_YEAR_AND_MONTH]
...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_Enrollment_Summary2b', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_Enrollment_Summary2b;
...
INTO
	mi_ATM881_ACOI.dbo.A_Enrollment_Summary2b
FROM
	(SELECT
		[INCURRED_YEAR_AND_MONTH]
		,[MEMBER_MONTH_START_DATE]
	...
	FROM
		...
		FROM mi_ATM881_ACOI.dbo.A_Enrollment_Key) as y)
	) as b
...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_Enrollment_Summary3', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_Enrollment_Summary3;
...
SELECT
	...
	,sum([AGE]) as [AGE]
INTO
	mi_ATM881_ACOI.dbo.A_Enrollment_Summary3
FROM
	mi_ATM881_ACOI.dbo.A_Enrollment_Summary1
GROUP BY
	[INCURRED_YEAR_AND_MONTH]
