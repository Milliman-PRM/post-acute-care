...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_tmp_SNF', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_tmp_SNF;
...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_SNF', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_SNF;
...
INTO
	mi_ATM881_ACOI.dbo.A_SNF
FROM
	mi_ATM881_ACOI.dbo.A_tmp_SNF as a
...
(84324 row(s) affected)
Warning: Null value is eliminated by an aggregate or other SET operation.

(42213 row(s) affected)
