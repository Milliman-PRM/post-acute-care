...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.tmpref_DRG', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.tmpref_DRG;

SELECT [DRG_CODE], [DRG_DESC]
INTO mi_ATM945_ACOI.dbo.tmpref_DRG
FROM [mi_ATM945].[dbo].[RFT_DRG]
WHERE DRG_TYPE = 'MS'
GO


IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_DRG', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_DRG;
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_DRG_wBnch', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_DRG_wBnch;
...
INTO
	mi_ATM945_ACOI.dbo.A_DRG_wBnch
FROM
	mi_ATM945_ACOI.dbo.A_DRG as a
	full join mi_ATM945_ACOI.dbo.A_Bnchmrk_DRG as b
	...
	left join mi_ATM945_ACOI.dbo.tmpref_DRG as x
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_DRG_Fam_wBnch', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_DRG_Fam_wBnch;
...
SELECT
	...
	, b.[DRG Family List]
INTO
	mi_ATM945_ACOI.dbo.A_DRG_Fam_wBnch
FROM
	mi_ATM945_ACOI.dbo.A_DRG_wBnch as a
...
(17387 row(s) affected)

(1462940 row(s) affected)
