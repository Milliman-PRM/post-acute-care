...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_tmp_PSA1', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_tmp_PSA1;
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_tmp_PSA2', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_tmp_PSA2;
...
SELECT
	...
	,b.excl
into
	mi_ATM945_ACOI.dbo.A_tmp_PSA2
from
	mi_ATM945_ACOI.dbo.A_tmp_PSA1 as a
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_tmp_PSA3', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_tmp_PSA3;
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_PSA', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_PSA;
...
INTO
	mi_ATM945_ACOI.dbo.A_PSA
FROM
	mi_ATM945_ACOI.dbo.A_tmp_PSA3 as a
...
(573816 row(s) affected)

(250820 row(s) affected)

(28466 row(s) affected)
