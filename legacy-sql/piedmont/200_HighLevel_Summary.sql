...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_Claim_Summary1', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_Claim_Summary1;
...
FROM
	...
	GROUP BY
		...
		,b.area, b.PCP_Name
		,x.HCG_SETTING_) as c
	right join mi_ATM945_ACOI.dbo.A_Enrollment_Summary2b as d
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_Demo_Sum', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_Demo_Sum;
...
FROM
	(SELECT
		...
		,sum(b.AGE) as AGE
	FROM
		mi_ATM945_ACOI.dbo.A_Enrollment_Summary2b as a
		right join mi_ATM945_ACOI.dbo.A_Enrollment_Key as b
