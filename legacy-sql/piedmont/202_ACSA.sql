...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_tmp_ACSA1', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_tmp_ACSA1;
...
INTO
	mi_ATM945_ACOI.dbo.A_tmp_ACSA1
FROM
	mi_ATM945.EBM.CI_EVENTS_NUM A 
	LEFT JOIN mi_ATM945.dbo.Services B
		ON -1*A.[SERVICES_KEY] = B.[SERVICES_KEY]
WHERE
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_tmp_ACSA2', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_tmp_ACSA2;
...
SELECT
	...
	,a.amt_paid
into
	mi_ATM945_ACOI.dbo.A_tmp_ACSA2
from
	mi_ATM945_ACOI.dbo.dat_Claims as a
	left join mi_ATM945_ACOI.dbo.A_tmp_ACSA1 as b
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_ACSA', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_ACSA;
...
INTO
	mi_ATM945_ACOI.dbo.A_ACSA
FROM
	mi_ATM945_ACOI.dbo.A_tmp_ACSA2 as a
