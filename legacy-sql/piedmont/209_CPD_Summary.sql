...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_tmp_CPD1', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_tmp_CPD1;
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_tmp_CPD2', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_tmp_CPD2;
...
FROM
	...
	from 
		...
		FROM mi_ATM945_ACOI.dbo.A_Enrollment_Key) as y) as a
	right join mi_ATM945_ACOI.dbo.A_Enrollment_Key as b
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_tmp_CPD3', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_tmp_CPD3;
...
SELECT
	...
	,sum(b.paid) as paid
INTO
	mi_ATM945_ACOI.dbo.A_tmp_CPD3
FROM
	mi_ATM945_ACOI.dbo.A_tmp_CPD2 as a
	left join mi_ATM945_ACOI.dbo.A_tmp_CPD1 as b
		on a.[MEMBER_ID] = b.[MEMBER_ID]
		and a.ASSN_STATUS = b.ASSN_STATUS
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_CPD2', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_CPD2;
...
INTO
	mi_ATM945_ACOI.dbo.A_CPD2
FROM
	mi_ATM945_ACOI.dbo.A_tmp_CPD3
GO


IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_tmp_CPD4', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_tmp_CPD4;
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_tmp_CPD5', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_tmp_CPD5;
...
SELECT
	...
	,sum(b.paid) as paid
INTO
	mi_ATM945_ACOI.dbo.A_tmp_CPD5
FROM
	mi_ATM945_ACOI.dbo.A_tmp_CPD2 as a
	left join mi_ATM945_ACOI.dbo.A_tmp_CPD4 as b
		on a.[MEMBER_ID] = b.[MEMBER_ID]
		and a.ASSN_STATUS = b.ASSN_STATUS
		and b.[MEMBER_MONTH_START_DATE] = a.[MEMBER_MONTH_START_DATE_2]
GROUP BY
...
(11237140 row(s) affected)
Warning: Null value is eliminated by an aggregate or other SET operation.

(1601189 row(s) affected)

(1601189 row(s) affected)
Warning: Null value is eliminated by an aggregate or other SET operation.

(5395605 row(s) affected)
Warning: Null value is eliminated by an aggregate or other SET operation.

(13872746 row(s) affected)
