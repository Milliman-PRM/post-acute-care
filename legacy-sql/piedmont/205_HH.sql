...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_tmp_HH1', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_tmp_HH1;
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_tmp_HH2', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_tmp_HH2;
...
SELECT
	...
	, max(e.er) as er
INTO
	mi_ATM945_ACOI.dbo.A_tmp_HH2
FROM
	mi_ATM945_ACOI.dbo.A_tmp_HH1 as a
	left join
		(
		SELECT
			FROM_DATE
...
IF OBJECT_ID('mi_ATM945_ACOI.dbo.A_HH', 'U') IS NOT NULL
DROP TABLE mi_ATM945_ACOI.dbo.A_HH;
...
INTO
	mi_ATM945_ACOI.dbo.A_HH
FROM
	mi_ATM945_ACOI.dbo.A_tmp_HH2 as a
