...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_tmp_PSA1', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_tmp_PSA1;
...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_tmp_PSA2', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_tmp_PSA2;
...
SELECT
	...
	,b.excl
into
	MI_CareNE_ACOI.dbo.A_tmp_PSA2
from
	MI_CareNE_ACOI.dbo.A_tmp_PSA1 as a
...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_tmp_PSA3', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_tmp_PSA3;
...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_PSA', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_PSA;
...
INTO
	MI_CareNE_ACOI.dbo.A_PSA
FROM
	MI_CareNE_ACOI.dbo.A_tmp_PSA3 as a
...
(367363 row(s) affected)

(176786 row(s) affected)

(15633 row(s) affected)
