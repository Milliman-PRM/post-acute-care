...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_tmp_SvcCatDet1', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_tmp_SvcCatDet1;
...
SELECT
	...
	, a.paid
INTO
	MI_CareNE_ACOI.dbo.A_tmp_SvcCatDet1
FROM
	(SELECT
...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_Svc_Cat_Detail', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_Svc_Cat_Detail;
...
SELECT
	...
	, sum(paid) as paid
INTO
	MI_CareNE_ACOI.dbo.A_Svc_Cat_Detail
FROM
	MI_CareNE_ACOI.dbo.A_tmp_SvcCatDet1
GROUP BY
	INCURRED_YEAR_AND_MONTH
...
(1169017 row(s) affected)

(245931 row(s) affected)
