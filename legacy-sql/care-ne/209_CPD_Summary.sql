...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_tmp_CPD1', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_tmp_CPD1;
...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_tmp_CPD2', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_tmp_CPD2;
...
FROM
	...
	from 
		...
		FROM MI_CareNE_ACOI.dbo.A_Enrollment_Key) as y) as a
	right join MI_CareNE_ACOI.dbo.A_Enrollment_Key as b
...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_tmp_CPD3', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_tmp_CPD3;
...
SELECT
	...
	,sum(b.paid) as paid
INTO
	MI_CareNE_ACOI.dbo.A_tmp_CPD3
FROM
	MI_CareNE_ACOI.dbo.A_tmp_CPD2 as a
	left join MI_CareNE_ACOI.dbo.A_tmp_CPD1 as b
		on a.[MEMBER_ID] = b.[MEMBER_ID]
		and a.ASSN_STATUS = b.ASSN_STATUS
...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_CPD2', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_CPD2;
...
INTO
	MI_CareNE_ACOI.dbo.A_CPD2
FROM
	MI_CareNE_ACOI.dbo.A_tmp_CPD3
GO


IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_tmp_CPD4', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_tmp_CPD4;
...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_tmp_CPD5', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_tmp_CPD5;
...
SELECT
	...
	,sum(b.paid) as paid
INTO
	MI_CareNE_ACOI.dbo.A_tmp_CPD5
FROM
	MI_CareNE_ACOI.dbo.A_tmp_CPD2 as a
	left join MI_CareNE_ACOI.dbo.A_tmp_CPD4 as b
		on a.[MEMBER_ID] = b.[MEMBER_ID]
		and a.ASSN_STATUS = b.ASSN_STATUS
		and b.[MEMBER_MONTH_START_DATE] = a.[MEMBER_MONTH_START_DATE_2]
GROUP BY
...
(19450456 row(s) affected)
Warning: Null value is eliminated by an aggregate or other SET operation.

(1906116 row(s) affected)

(1906116 row(s) affected)
Warning: Null value is eliminated by an aggregate or other SET operation.

(5701220 row(s) affected)
Warning: Null value is eliminated by an aggregate or other SET operation.

(16353549 row(s) affected)
