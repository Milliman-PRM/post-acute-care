...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_tmp_HH1', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_tmp_HH1;
...
FROM
	...
	left join MI_CareNE_ACOI.dbo.tmpref_ccn_flag as c
...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_tmp_HH2', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_tmp_HH2;
...
SELECT
	...
	, max(e.er) as er
INTO
	MI_CareNE_ACOI.dbo.A_tmp_HH2
FROM
	MI_CareNE_ACOI.dbo.A_tmp_HH1 as a
	left join
		(
		SELECT
			FROM_DATE
...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_HH', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_HH;
...
INTO
	MI_CareNE_ACOI.dbo.A_HH
FROM
	MI_CareNE_ACOI.dbo.A_tmp_HH2 as a
