...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_tmp_SNF', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_tmp_SNF;
...
IF OBJECT_ID('MI_CareNE_ACOI.dbo.A_SNF', 'U') IS NOT NULL
DROP TABLE MI_CareNE_ACOI.dbo.A_SNF;
...
INTO
	MI_CareNE_ACOI.dbo.A_SNF
FROM
	MI_CareNE_ACOI.dbo.A_tmp_SNF as a
