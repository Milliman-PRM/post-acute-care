...
IF OBJECT_ID('mi_ATM881_ACOI.demo.A_tmp_ACSA1', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.demo.A_tmp_ACSA1;
...
SELECT
	...
	,max(case when A.CI_MEASURE_ID = 'PQI_09_2016' then 1 else 0 end) as PQI9
...
INTO
	mi_ATM881_ACOI.demo.A_tmp_ACSA1
FROM
	mi_ATM881.EBM.CI_EVENTS_NUM A
	LEFT JOIN mi_ATM881.dbo.Services B
...
IF OBJECT_ID('mi_ATM881_ACOI.demo.A_tmp_ACSA2', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.demo.A_tmp_ACSA2;
...
SELECT
	...
	,a.amt_paid
into
	mi_ATM881_ACOI.demo.A_tmp_ACSA2
from
	mi_ATM881_ACOI.demo.dat_Claims as a
	left join mi_ATM881_ACOI.demo.A_tmp_ACSA1 as b
...
IF OBJECT_ID('mi_ATM881_ACOI.demo.A_ACSA', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.demo.A_ACSA;
...
INTO
	mi_ATM881_ACOI.demo.A_ACSA
FROM
	mi_ATM881_ACOI.demo.A_tmp_ACSA2 as a
...
(26548 row(s) affected)

(40946 row(s) affected)

(24857 row(s) affected)
