...
IF OBJECT_ID('mi_ATM881_ACOI.demo.A_tmp_SNF', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.demo.A_tmp_SNF;
...
IF OBJECT_ID('mi_ATM881_ACOI.demo.A_SNF', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.demo.A_SNF;
...
INTO
	mi_ATM881_ACOI.demo.A_SNF
FROM
	mi_ATM881_ACOI.demo.A_tmp_SNF as a
...
(27994 row(s) affected)
Warning: Null value is eliminated by an aggregate or other SET operation.

(19630 row(s) affected)
