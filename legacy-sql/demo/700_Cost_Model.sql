...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_Cost_Model', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_Cost_Model;
...
SELECT
	...
	, a.paid
INTO
	mi_ATM881_ACOI.dbo.A_Cost_Model
FROM
	(SELECT
...
IF OBJECT_ID('mi_ATM881_ACOI.dbo.A_Cost_Model_wBnch', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.dbo.A_Cost_Model_wBnch;
...
INTO
	mi_ATM881_ACOI.dbo.A_Cost_Model_wBnch
FROM
	mi_ATM881_ACOI.dbo.A_Cost_Model as a
	full join mi_ATM881_ACOI.dbo.A_Bnchmrk_Cost_Model as b
...
(103249 row(s) affected)

(121974 row(s) affected)
