...
IF OBJECT_ID('mi_ATM881_ACOI.demo.A_tmp_SvcCatDet1', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.demo.A_tmp_SvcCatDet1;
...
SELECT
	...
	, a.paid
INTO
	mi_ATM881_ACOI.demo.A_tmp_SvcCatDet1
FROM
	(SELECT
...
IF OBJECT_ID('mi_ATM881_ACOI.demo.A_Svc_Cat_Detail', 'U') IS NOT NULL
DROP TABLE mi_ATM881_ACOI.demo.A_Svc_Cat_Detail;
...
SELECT
	...
	, sum(paid) as paid
INTO
	mi_ATM881_ACOI.demo.A_Svc_Cat_Detail
FROM
	mi_ATM881_ACOI.demo.A_tmp_SvcCatDet1
GROUP BY
	INCURRED_YEAR_AND_MONTH
...
(2945297 row(s) affected)
Warning: Null value is eliminated by an aggregate or other SET operation.

(601729 row(s) affected)
